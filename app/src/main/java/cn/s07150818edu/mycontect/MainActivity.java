        ...
        switch (item.getItemId()){
            case 1:
                if (!nameEditText.getText().toString().equals("")) {
                    ...
                    user.setMoble(mobileEditText.getText().toString());
                    ...
                    if (ct.addData(user)) {
                        ...
                        Toast.makeText(MainActivity.this, "添加失败", Toast.LENGTH_SHORT);
                    }
                }else{
                    Toast.makeText(MainActivity.this, "请输入数据", Toast.LENGTH_SHORT);
                }
                break;
        }
